...
const POST_INIT = {creator:'', title:'', message:'', tags:'', selectedFile:''}
const Form = ({currentId, setCurrentId}) => {
  
  const [postData, setPostData] = useState(POST_INIT)
  ...
  <Paper className='paper'>
    <form autoComplete='off' noValidate className='form' onSubmit={handleSubmit}>
      ...
      <TextField style={{paddingBottom:'1rem', fontWeight:'bold'}} name='message' variant='outlined' label='Message' fullWidth value={postData.message} onChange={(e)=>setPostData({...postData, message: e.target.value})}/>
      ...
      <Button style={{marginBottom:10}} variant='contained' color='primary' size='large' type='submit' fullWidth>Subimt</Button>
